...
namespace C43_G05_LINQ02
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            #region quontifieres operatores

            //quontifieres operatores**return boolean**
            //Any //all //sequenceequal //contains

            // var seqo1 = Enumerable.Range (1, 10);

            // var seqo2 = Enumerable.Range(20, 30);

            // //Any()return true if there are at least an element {in sequence or match the condition}
            // var result = seqo1.Any(N=> N%2 ==0);
            // ProductList = new List<Product>();
            //// var result = ProductList.Any(p=>p.UnitsInStock == 0);
            // Console.WriteLine(result);
            //all return true in all elements in the sequence match the consitions or sequence is empty
            //sequenace equal : 
            //containes
            #endregion
            ...
            //List<int> Numberes = new List<int>() { 10,20,30,40 };

            //var result = Word.Zip(Numberes,(W,N))=>$"{N}=>{W}");
